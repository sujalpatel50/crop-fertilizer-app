...
try:
    crop_model = pickle.load(open("D:/ME research work/crop_model.pkl", "rb"))
    fertilizer_model = pickle.load(open("D:/ME research work/fertilizer_model.pkl", "rb"))
    scaler_crop = pickle.load(open("D:/ME research work/scaler_crop.pkl", "rb"))
    label_encoder_crop = pickle.load(open("D:/ME research work/label_encoder.pkl", "rb"))
    label_encoder_soil = pickle.load(open("D:/ME research work/label_encoder_soil.pkl", "rb"))
    label_encoder_fertilizer = pickle.load(open("D:/ME research work/label_encoder_fertilizer.pkl", "rb"))
    label_encoder_crop_fertilizer = pickle.load(open("D:/ME research work/label_encoder_crop.pkl", "rb"))
    soil_classes = pickle.load(open("D:/ME research work/soil_classes.pkl", "rb"))
    fertilizer_classes = pickle.load(open("D:/ME research work/fertilizer_classes.pkl", "rb"))
